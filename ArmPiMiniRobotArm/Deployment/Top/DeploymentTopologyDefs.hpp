...
#include "ArmPiMiniRobotArm/Deployment/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
    namespace ArmPiMiniRobotArm_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
    namespace ArmPiMiniRobotArm_rateGroup2 {enum { WARN = 3, FATAL = 5 };}
    namespace ArmPiMiniRobotArm_rateGroup3 {enum { WARN = 3, FATAL = 5 };}
    namespace ArmPiMiniRobotArm_cmdSeq {enum { WARN = 3, FATAL = 5 };}
}  // namespace PingEntries
