// ======================================================================
// \title  ArmPiMiniRobotArmTopology.cpp
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::ArmPiMiniRobotArm_blockDrv::WARN, PingEntries::ArmPiMiniRobotArm_blockDrv::FATAL, "blockDrv"},
    {PingEntries::ArmPiMiniRobotArm_tlmSend::WARN, PingEntries::ArmPiMiniRobotArm_tlmSend::FATAL, "chanTlm"},
    {PingEntries::ArmPiMiniRobotArm_cmdDisp::WARN, PingEntries::ArmPiMiniRobotArm_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::ArmPiMiniRobotArm_cmdSeq::WARN, PingEntries::ArmPiMiniRobotArm_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::ArmPiMiniRobotArm_eventLogger::WARN, PingEntries::ArmPiMiniRobotArm_eventLogger::FATAL, "eventLogger"},
    {PingEntries::ArmPiMiniRobotArm_fileDownlink::WARN, PingEntries::ArmPiMiniRobotArm_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::ArmPiMiniRobotArm_fileManager::WARN, PingEntries::ArmPiMiniRobotArm_fileManager::FATAL, "fileManager"},
    {PingEntries::ArmPiMiniRobotArm_fileUplink::WARN, PingEntries::ArmPiMiniRobotArm_fileUplink::FATAL, "fileUplink"},
    {PingEntries::ArmPiMiniRobotArm_prmDb::WARN, PingEntries::ArmPiMiniRobotArm_prmDb::FATAL, "prmDb"},
    {PingEntries::ArmPiMiniRobotArm_rateGroup1::WARN, PingEntries::ArmPiMiniRobotArm_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::ArmPiMiniRobotArm_rateGroup2::WARN, PingEntries::ArmPiMiniRobotArm_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::ArmPiMiniRobotArm_rateGroup3::WARN, PingEntries::ArmPiMiniRobotArm_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(ArmPiMiniRobotArmPacketsPkts, ArmPiMiniRobotArmPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name ArmPiMiniRobotArm
...
void startSimulatedCycle(Fw::TimeInterval interval) {
    ...
    // Main loop
    while (cycling) {
        ArmPiMiniRobotArm::blockDrv.callIsr();
